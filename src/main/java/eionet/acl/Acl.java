 ...
 * </ul>
 *
 * The {@code  eionet.acl } package provides the
 * interfaces to the ACL and related data structures (ACL entries,
 * groups, permissions, etc.).<p>
 *
 * The {@code  eionet.acl.Acl } interface extends the
 * {@code  eionet.acl.Owner } interface. The Owner
 ...
 * to the ACL.
 *
 * @see eionet.acl.AclEntry
 * @see eionet.acl.Owner
 * @see eionet.acl.Acl#getPermissions
 *
